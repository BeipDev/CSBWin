...
#define RESTARTMAP           \
   ...
   switch(mystate)           \
   {                         \
      case _0_: goto return_0_;

#define RESTART(n) \
   case _##n##_: goto return_##n##_;

#define END_RESTARTMAP                    \
   default: ASSERT(0, "Illegal RESTART"); \
      }                                   \
      ;                                   \
   return_0_:
