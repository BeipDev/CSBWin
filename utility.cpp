...
void TAG00053a(i16, i32)
{
   ...
   for(;;)
   {
      ...
      if((w_4 >= 0) || ((w_2 = TAG0009ee(0x500)) == 0))
      {
         ...
         if(w_2 == 0)
         {
            ...
            //
            if((p_8 != NULL) || ((w_2 = TAG0009ee(0x501)) == 0))
            {
...
i16 LoadProgram(STRUCT148 *s148)
{
   ...
   { // This is a fake loop.  There are a lot of jumps
      ...
      if((b_74[0] != 0x61) || (b_74[1] != 0x60) || (b_74[4] != 0) || (b_74[5] != 2) || (b_74[6] != 1) || (b_74[7] != 0))
      {
         D7W = TAG0009ee(1);
         if(D7W != 0)
            break;
      ...
      i_14 = LE32(longGear(b_114 + 4)) + LE32(longGear(b_114)) + LE32(longGear(b_114 + 20)) + 12;
