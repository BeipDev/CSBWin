...
tag0065e0:
   ...
   w_160 = (D0W & 1) != 0;
   //
   if(w_160 && ((RelativeCellNumber < 3) || (RelativeCellNumber > 9) || (D5W != CurAbsPos)))
      goto tag006ab6;
   w_162 = 0;
   ...
   else
   {
      ...
      else
      {
         ...
         {
            i32 idx;
            D0L = GetGraphicClass(RecordName(RNLightning));
            idx = sw(-D0W) - 1;
...
void DrawMonster(
    ...
    const RecordName objMonster_54,
    ...
    const i16 PositionListIndex)
{
   ...
   // D1W = D6W;
   LOCAL_96 = ((positionWithinCell <= 1) || (PositionListIndex == 1)) && ((PositionList == 0) || ((PositionList & 15) >= 3));
   // LOCAL_96 means working on last of far positions.
   if((objMonster_54 == RNnul) || FinishedDrawingMonsters_108)
      return;
   ...
   if(drawAsSize4)
      ...
      MonsterSize_72 = pmtDesc->horizontalSize();
   ...
   MonsterAbsFacing_182 = (I16)(TwoBitNibble(pi16_62->facings(),
   ...
   { // If we have an opportunity to draw it later then exit now.
      ...
      if((PositionList) || (sideOfDoor == SOD_FarSideOfDoor))
         return;
   ...
   for(;;)
   {
      ...
      if(pMonsterXYonScreen_16[1] != 0)
      {
         ...
         showSideView_98 = mtDescWord4_76.HasSideGraphic() && ((MonsterRelFacing_74 & 1) != 0);
         if(showSideView_98)
         {
         ...
         else
         {
            ...
            showBackView_100 = mtDescWord4_76.HasBackGraphic() && (MonsterRelFacing_74 == 0);
            ...
            //                     && ((mtDescWord4_76 & 32) != 0);
            showAttackView_104 = !showBackView_100 && sms_78.TestAttacking() && mtDescWord4_76.HasAttackGraphic();
            ...
            { // Front view (non-attacking) or back view
               ...
               else // non-attacking front view
               {
                  ...
                  //         && sms_78.TestBit6();
                  frontViewMirror_106 = mtDescWord4_76.NonAttackingMirrorOK() && sms_78.TestMirror();
         ...
         {    // RelativeCellNumber <= 5 (two or more rows ahead)
            ...
            {                           // Exactly two rows ahead.
               ...
               // };
               // w_102 = (I16)(D0W & 1);
               b_102 = mtDescWord4_76.HasBit7() && !showSideView_98 && !showBackView_100 && !showAttackView_104;
    ...
    tag005e98:
    */
            if((showSideView_98) && (MonsterRelFacing_74 == 1) || (showAttackView_104) && (sms_78.TestMirror())
...
{ // Return true if graphic already exists.
   ...
   if(width == 0)
      die(0x3334, "Alternate Zero Width");
...
ALTMONGRAPH *GetAlternateGraphicsRecord(DB4 *pMonster)
{
   ...
   if((altMonCache[mt][altGraphic].graphicID >= 0) && (altMonCache[mt][altGraphic].graphicID != id))
   {
   ...
   if(pGraphic == NULL)
   {
      ...
      if(altMonCache[mt][altGraphic].size == 0)
         return NULL;
    ...
    const ALTMONGRAPH *pAlternateGraphic)
{
   ...
   // alternate graphics agree in size with the standard graphics.
      ...
      MonsterSize_72 = d.MonsterDescriptor[pDB4_58->monsterType()].horizontalSize();
   mtDescWord4_76 = pmtDesc->word4;
   //};
   pI12_A2 = pI12_70; // Monster's graphic information
   // If we are drawing as if the monster were size 4 then
    ...
    const RecordName objD7)
{
   ...
   LOCAL_36 = ((pGraphicClass->byte4 & 1) != 0) && (!LOCAL_34) && ((MiddleLeftRight == 2) || (MiddleLeftRight == 0) && rightSideOfCell);
   LOCAL_30 = 0;
   ...
   else
   {
      ...
      if((RelativeCellNumber >= 6) || ((RelativeCellNumber >= 3) && nearSideOfCell))
      {
         w_18 += 1;
         distanceFromUs_52 = 1;
    ...
    bool FinishedDrawingMonsters_108)
{
   ...
   // ITEM16 *pi16_62 = NULL;
   // DB4    *pDB4_58 = NULL;
   RecordName objMonster_54(RNnul);
   ...
   for(objD7 = FirstObject; objD7 != RNeof; objD7 = GetDBRecordLink(objD7))
   {
      ...
      switch(dbType)
      {
         ...
         case dbCLOUD:
            ...
            break;
         default:
            if(RelativeCellNumber < 0)
               break;
            if(RelativeCellNumber > 9)
               break;
            if(CurAbsPos != objD7.pos())
               break;
            ProcessOneObject(
                objD7,
                rect_42,
   ...
   if((MissilePresent == 0) || ((RelativeCellNumber = RelativeCell_46) > 9))
      return; // finished this position
   ...
   {
      // tag006080:
      if(objD7.dbType() != dbMISSILE)
         continue; // fireball is 14
      if(objD7.pos() != CurAbsPos)
         continue;
      ...
      //
      //
      if(((w_130 != 0) || (pDB14_118->rangeRemaining() == 255)) && (RelativeCellNumber == 9))
      {
         w_112 = 0;
         // LOCAL_22 = (UI8)(A2[2]);
      ...
      else // a
      {
         ...
         {
            if((w_126 >= 2) || (w_126 == 1) && (w_124 != facing) || (w_140 != 0) && (w_138 != 0))
            {
               w_128 = 0;
            }
            else
...
{ // Drawing Order executed four bits at a time from
   ...
   i16 RelativeCell_46;
   RecordName FirstObject; // 44// set to parameter 'firstObject' forever
   // RectPos        rect_42;
   // bool           LOCAL_38;
   // bool           LOCAL_36;
   // i16            LOCAL_34;
   ...
   {
      if(DrawingOrder & 1)
         sideOfDoor = SOD_NearSideOfDoor;
      else
         sideOfDoor = SOD_FarSideOfDoor;
...
i32 GetGraphicClass(RecordName P1)
{
   dReg D5, D6;
   ...
   if(D6W == dbCLOUD)
   {
      ...
      if(objD7 == RNPoison)
         return -13;
      if(objD7 == RNLightning)
         return -4;
      if(objD7 == RNPoisonBolt)
         return -14;
      if(objD7 == RNPoisonCloud)
         return -14;
      return -12;
   }
   else
...
//
//*********************************************************
WEAPONDESC *TAG0099d2(RecordName object)
{
   DB5 *pDB5_4;
   //;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
