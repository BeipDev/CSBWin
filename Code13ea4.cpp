   ...
   for(;;)
   {
      ...
      while(IsPlayFileOpen() || UI_CONSTAT() == 0)
      {
         ...
         // if ((w_18!=0) && (w_20==0))
         {
            ...
            //
            if(((D6W == 2) || (D7W > 0)) && (w_14 >= 197) && (w_14 <= 215) && (w_16 >= 147) && (w_16 <= 155)) // Name non-blank and pressed 'OK'
            {
               w_22 = D7W;
            ...
            {
               if((w_14 >= 107) && (w_14 <= 175) && (w_16 >= 147) && (w_16 <= 155)) // Backspace button
               {
                  D5W = 8;
                  break;
               }
               if((w_14 >= 107) && (w_14 <= 215) && (w_16 >= 116) && (w_16 <= 144)) // Letters, punctuation, carriage-return
               {
      ...
      //
      if(((D5W >= 'A') && (D5W <= 'Z')) || (D5W == '.') || (D5W == 44) || (D5W == 59) || (D5W == 58) || (D5W == ' '))
      {
         if(D5W == ' ')
         {
            if(D7W == 0)
