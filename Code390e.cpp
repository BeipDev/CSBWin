...
{ //()
   ...
   LOCAL_10 = 0;
   if(d.Word7254 != 0)
      LOCAL_10 = 1; // If we've never been here before!
   pA0 = d.pCurLevelDesc;
   LOCAL_22 = 0;
   if(LOCAL_10 != 0)
      LOCAL_22 = 1;
   if(d.CurrentFloorAndCeilingGraphic != d.pCurLevelDesc->backgroundGraphicSet())
      LOCAL_22 = 1;
   if(d.CurrentWallGraphic != d.pCurLevelDesc->wallGraphicSet())
      LOCAL_22 = 1;
   //
   if(LOCAL_22 != 0)
   {
      ...
      for(LOCAL_16 = 0; LOCAL_16 < 3; LOCAL_16++)
      {
         ...
         if(decorationIndex == D1W)
         {
            ...
            if(decorationIndex == 2)
               d.OrnateAlcoveGraphicIndex = D5W;
         }
      }
