...
void SortWords(i16 *entries, i16 numEnt)
{
   ...
   for(i = logNumEnt - 1; i >= 0; i--)
   {
      ...
      for(uwD6 = uwLOCAL_6; uwD6 <= uwLOCAL_8; uwD6++) // 2nd half of current part??
      {
         ...
         for(;;)
         {
            ...
            {
               uwD0 = entries[uwD5 + 1];
               if((ui16)uwD0 >= entries[uwD5])
                  uwD5++;
            }
            if((ui16)uwD4 >= (ui16)entries[uwD5])
               break;
            uwD0 = entries[uwD5];
            entries[uwD7] = uwD0;
            uwD7 = uwD5;
   ...
   for(uwLOCAL_6 = uw(numEnt - 1); uwLOCAL_6 != 0; uwLOCAL_6--)
   {
      ...
      for(;;)
      {
         ...
         {
            uwD0 = entries[uwD5 + 1];
            if(uwD0 >= entries[uwD5])
               uwD5++;
         }
         if(uwD4 >= entries[uwD5])
            break;
         uwD0 = entries[uwD5];
         entries[uwD7] = uwD0;
         uwD7 = uwD5;
...
{ //()
   ...
   {
      D5W = P1[D7W];
      while(((D6W = sw(D7W + 1)) < count) && (D5W == P1[D6W]))
      {
   ...
   d.Pointer23314 = A2;
   if(d.Word23328 != 0)
      d.pStartAvailMemory = (ui8 *)d.Pointer23314;
   TAG021234();
   FreeTempMemory(5004);
   return;
}
